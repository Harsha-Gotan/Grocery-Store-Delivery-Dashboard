...
- *Orders by City Tier*: Pie chart with balanced distribution (~3K each).
- *Shop Openings Over Time*: Line chart showing consistent openings from 2021 to 2024.
- *Sales by Category*: Bar chart highlighting top categories like Fruits & Vegetables (~0.2M) and Snack Foods (~0.18M).
